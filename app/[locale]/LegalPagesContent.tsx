...
// ===== 利用規約 =====
const termsSections = [
  { title: "サービスの概要", content: `toolio（以下「当サービス」）は、国内外でにほんごを学ぶこどもたちのための教材プラットフォームです。海外在住の継承語家庭のお子様、および日本国内の外国籍の日本語学習者など、様々な環境でにほんごを学ぶこどもたちを支援することを目的としています。教材のダウンロード・閲覧・印刷などの機能を提供します。当サービスは学校の先生・日本語教室の先生・保護者を主な対象としています。` },
  ...
  { title: "プランと利用権限", content: `当サービスは以下の3つのプランを提供しており、プランによってアクセスできる教材の範囲が異なります。\n\n【プラン一覧】\n・toolio free（無料）\n　→ 無料教材のダウンロード・お気に入り・ダウンロード履歴・単品購入\n\n・toolio weekly unlimited（週額498円・税込）\n　→ 全教材使い放題・お気に入り無制限・ダウンロード履歴無制限\n\n・toolio monthly unlimited（月額1,480円・税込）\n　→ 全教材使い放題・お気に入り無制限・ダウンロード履歴無制限` },
  { title: "サブスクリプション・都度購入", content: `有料プランは週次または月次サブスクリプション形式です。toolio free への変更はマイページからいつでも行えます。変更後は次回更新日までサービスをご利用いただけます。料金の返金は原則として行っておりません。\n\n【都度購入】\n全てのご利用者は、対象教材を1点あたり300円（税込）で単品購入することも可能です。購入した教材はサブスクリプションの有無に関わらずダウンロード可能ですが、本規約に定める利用範囲の制限は引き続き適用されます。` },
...
const faqCategories = [
  {
    label: "サービスについて",
    faqs: [
      { q: "toolioとはどんなサービスですか？", a: "toolioは、海外でにほんごを学ぶこどもたちのための教材プラットフォームです。ひらがな・カタカナ・漢字・算数など、さまざまな教材を印刷してすぐ使える形でご提供しています。先生や保護者の方がすぐに授業や家庭学習に取り入れられるよう、使い方ガイドも一緒にご用意しています。" },
      ...
      { q: "どんな人向けのサービスですか？", a: "主に海外の日本語補習校・国際校・日本語学校の先生、および海外在住のにほんごを学ぶお子さんをお持ちの保護者の方を対象としています。にほんごを母語としない環境で育つこどもたちが、たのしくにほんごを学べる教材を提供しています。" },
    ],
  },
  {
    label: "アカウント・登録",
  ...
  },
  {
    label: "プラン・料金",
    faqs: [
      { q: "サブスクリプションプランの違いは何ですか？", a: "toolio free では一部の無料教材と単品購入がご利用いただけます。toolio weekly unlimited（週額498円）・toolio monthly unlimited（月額1,480円）では全教材が使い放題になります。週払いより月払いの方がお得です。" },
      ...
      {notionBody ? (
        ...
        <>
          <section style={{ marginBottom: 56 }}>
            ...
            <p style={{ fontSize: 15, color: "#555", lineHeight: 2, marginBottom: 16 }}>toolioは、にほんごを学ぶ子供を支える先生・保護者のための日本語学習ツールサイトです。学校でも・ご家庭でもすぐに使えるツールを提供しています。</p>
            <p style={{ fontSize: 15, color: "#555", lineHeight: 2 }}>かるた・ゲーム・ロールプレイなど、子供が自然にたのしめる活動ベースの教材をPDF形式で提供。ダウンロードしてすぐに授業や家庭学習に取り入れられます。</p>
          </section>
          <section style={{ marginBottom: 56 }}>
            <h3 style={{ fontSize: 18, fontWeight: 800, color: "#7a50b0", marginBottom: 16 }}>こんな方におすすめ</h3>
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 10 }}>
              {["日本語補習校・国際校・日本語学校の先生", "にほんごを学ぶお子さんをお持ちの保護者", "海外在住・国内在住どちらも対応", "就学前〜小学生のお子さんの指導に"].map((item) => (
          ...
          <section style={{ marginBottom: 56 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {[
                { title: "たのしい活動ベースの教材", desc: "かるた・ゲーム・ロールプレイなど、子供が自分から「やりたい！」と言える教材を揃えています。説明は最小限で、たのしみながら自然ににほんごが身につきます。", color: "#fce4f8", border: "#e49bfd" },
          ...
          <section style={{ marginBottom: 56 }}>
            ...
            <div style={{ background: "white", border: "0.5px solid rgba(200,170,240,0.3)", borderRadius: 16, padding: "28px 32px" }}>
              <p style={{ fontSize: 15, color: "#555", lineHeight: 2, marginBottom: 16 }}>子供たちは、たのしんでいる時ほど、自然に言葉を覚えています。かるたで遊びながら気づいたら単語を言えるようになっていた。ゲームに夢中になりながら、気づいたら文が出てきた。</p>
              <p style={{ fontSize: 15, color: "#555", lineHeight: 2 }}>「たのしい活動」→「気づいたらにほんごに触れてる」→「あれ、できた！」→「またやりたい！」——このループを繰り返すことで、勉強した感覚がないまま、できることが増えていく。それがtoolioの学び方です。</p>
            </div>
          </section>
