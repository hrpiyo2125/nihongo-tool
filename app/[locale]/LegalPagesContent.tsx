...
const faqCategories = [
  ...
  },
  {
    label: "プラン・料金",
    faqs: [
      { q: "サブスクリプションプランの違いは何ですか？", a: "無料プランでは一部の教材をご利用いただけます。ライトプラン（月額500円）では単品購入・ライト教材が利用可能になります。スタンダードプラン（月額980円）ではスタンダード教材まで、プレミアムプラン（月額1,480円）ではプレミアムプランまでの全教材がご利用いただけます。" },
