...
function TroubleSection({ onOpenModal, onHome }: { onOpenModal: () => void; onHome: () => void }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" as const }}>
      <div style={{ padding: "24px 20px 0", background: "white" }}>
        <p style={{ fontSize: 13, color: "#aaa", marginBottom: 16, lineHeight: 1.8 }}>日本語指導でよくあるお悩みに、一緒に向き合います。</p>
...
function _GuideSectionStub() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" as const }}>
      <div style={{ padding: "24px 20px 0", background: "white" }}>
        <p style={{ fontSize: 13, color: "#aaa", marginBottom: 16, lineHeight: 1.8 }}>toolioの使い方をご案内します。</p>
        <div style={{ display: "flex", borderBottom: "0.5px solid rgba(200,170,240,0.25)", gap: 0, overflowX: "auto" as const }}>
          {guideTabs.map((tab) => {
