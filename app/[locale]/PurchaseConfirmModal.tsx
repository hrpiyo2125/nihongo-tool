...
export default function PurchaseConfirmModal({ mat, onSuccess, onClose }: Props) {
  ...
  return (
    <div onClick={onClose} style={{ position: "fixed", inset: 0, zIndex: 400, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div onClick={e => e.stopPropagation()} style={{ background: "white", borderRadius: 20, width: "100%", maxWidth: 480, padding: "36px 32px", position: "relative", boxShadow: "0 16px 64px rgba(0,0,0,0.2)" }}>
        ...
        <div style={{ fontSize: 20, fontWeight: 800, color: "#333", marginBottom: 6 }}>教材を購入</div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 0", borderTop: "0.5px solid #eee", borderBottom: "0.5px solid #eee", marginBottom: 20 }}>
          <div>
            ...
            <div style={{ fontSize: 22, fontWeight: 800, color: "#333" }}>¥350</div>
          </div>
