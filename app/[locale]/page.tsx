...
const navItems: NavItem[] = [
  ...
  const contentTabs = [
  { id: "all",      label: cl.all,      char: "✦", color: "#e8efff", imageSrc: "/contents/all.png" },
  { id: "hiragana", label: cl.hiragana, char: "あ", color: "#e8efff", imageSrc: "/contents/hiragana.png" },
  { id: "katakana", label: cl.katakana, char: "ア", color: "#f0e8ff", imageSrc: "/contents/kanakana.png" },
  { id: "kanji",    label: cl.kanji,    char: "字", color: "#ffe8f4", imageSrc: "/contents/kanji.png" },
  { id: "joshi",      label: cl.joshi,      char: "は", color: "#fff0ec", imageSrc: "/contents/joshi.png" },
  { id: "kaiwa",      label: cl.kaiwa,      char: "話", color: "#f8e8ff", imageSrc: "/contents/kaiwa.png" },
  { id: "season",     label: cl.season,     char: "季", color: "#e8efff", imageSrc: "/contents/season.png" },
  { id: "food",       label: cl.food,       char: "🍎", color: "#fff0e8", imageSrc: "/contents/food.png" },
  { id: "animal",     label: cl.animal,     char: "🐾", color: "#e8f8ee", imageSrc: "/contents/animal.png" },
  { id: "body",       label: cl.body,       char: "💪", color: "#ffe8f4", imageSrc: "/contents/body.png" },
  { id: "color",      label: cl.color,      char: "🔵", color: "#f0e8ff", imageSrc: "/contents/color.png" },
  { id: "number",     label: cl.number,     char: "数", color: "#e8f8ff", imageSrc: "/contents/number.png" },
  { id: "adjective",  label: cl.adjective,  char: "い", color: "#fff8e0", imageSrc: "/contents/keiyoushi.png" },
  { id: "verb",       label: cl.verb,       char: "動", color: "#e8f8ee", imageSrc: "/contents/doushi.png" },
  { id: "conjunction",label: cl.conjunction,char: "接", color: "#f0e8ff", imageSrc: "/contents/setsuzokushi.png" },
  { id: "grammar",    label: cl.grammar,    char: "文", color: "#f0ffe8", imageSrc: "/contents/bunpo.png" },
  { id: "familiar",   label: cl.familiar,   char: "🏠", color: "#e8efff", imageSrc: "/contents/mijika.png" },
  { id: "kotoba",     label: cl.kotoba,     char: "語", color: "#fff0e8", imageSrc: "/contents/word.png" },
  { id: "vegefruit",  label: cl.vegefruit,  char: "🥦", color: "#e8f8ee", imageSrc: "/contents/yasai.png" },
];
...
const methodTabs: { id: string; label: string; char: string; imageSrc: string | null }[] = [
  ...
  const contentItems = [
  { label: cl.hiragana, char: "あ", color: "#e8efff", imageSrc: "/contents/hiragana.png", contentId: "hiragana" },
  { label: cl.katakana, char: "ア", color: "#f0e8ff", imageSrc: "/contents/kanakana.png", contentId: "katakana" },
  { label: cl.kanji,    char: "字", color: "#ffe8f4", imageSrc: "/contents/kanji.png",    contentId: "kanji" },
  { label: cl.joshi,      char: "は", color: "#fff0ec", imageSrc: "/contents/joshi.png",    contentId: "joshi" },
  { label: cl.kaiwa,      char: "話", color: "#f8e8ff", imageSrc: "/contents/kaiwa.png",    contentId: "kaiwa" },
  { label: cl.season,     char: "季", color: "#e8efff", imageSrc: "/contents/season.png",   contentId: "season" },
  { label: cl.food,       char: "🍎", color: "#fff0e8", imageSrc: "/contents/food.png",     contentId: "food" },
  { label: cl.animal,     char: "🐾", color: "#e8f8ee", imageSrc: "/contents/animal.png",   contentId: "animal" },
  { label: cl.body,       char: "💪", color: "#ffe8f4", imageSrc: "/contents/body.png",     contentId: "body" },
  { label: cl.color,      char: "🔵", color: "#f0e8ff", imageSrc: "/contents/color.png",    contentId: "color" },
  { label: cl.number,     char: "数", color: "#e8f8ff", imageSrc: "/contents/number.png",   contentId: "number" },
  { label: cl.adjective,  char: "い", color: "#fff8e0", imageSrc: "/contents/keiyoushi.png", contentId: "adjective" },
  { label: cl.verb,       char: "動", color: "#e8f8ee", imageSrc: "/contents/doushi.png",      contentId: "verb" },
  { label: cl.conjunction,char: "接", color: "#f0e8ff", imageSrc: "/contents/setsuzokushi.png", contentId: "conjunction" },
  { label: cl.grammar,    char: "文", color: "#f0ffe8", imageSrc: "/contents/bunpo.png",      contentId: "grammar" },
  { label: cl.familiar,   char: "🏠", color: "#e8efff", imageSrc: "/contents/mijika.png",     contentId: "familiar" },
  { label: cl.kotoba,     char: "語", color: "#fff0e8", imageSrc: "/contents/word.png",       contentId: "kotoba" },
  { label: cl.vegefruit,  char: "🥦", color: "#e8f8ee", imageSrc: "/contents/yasai.png",      contentId: "vegefruit" },
