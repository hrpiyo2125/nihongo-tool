...
export default function PlanPage() {
  return (
    <div style={{ minHeight: "100vh", fontFamily: "'Hiragino Sans', 'Yu Gothic', 'Noto Sans JP', sans-serif", background: "#f8f4f4" }}>
      <style>{`
        .plan-header-mobile { display: none; }
        .plan-header-desktop { display: block; }
        @media (max-width: 767px) {
          .plan-header-mobile { display: flex; }
          .plan-header-desktop { display: none; }
        }
      `}</style>

      {/* モバイル用ヘッダー */}
      <header className="plan-header-mobile" style={{ height: 56, alignItems: "center", padding: "0 16px", borderBottom: "0.5px solid rgba(200,170,240,0.2)", background: "white", gap: 12 }}>
      ...
      {/* デスクトップ用ヘッダー */}
      <div className="plan-header-desktop" style={{ padding: "48px 0 36px", textAlign: "center", background: "linear-gradient(to bottom, rgba(255,255,255,0) 5%, rgba(255,255,255,1) 80%), linear-gradient(to right, rgba(244,185,185,0.55) 0%, rgba(228,155,253,0.55) 50%, rgba(163,192,255,0.55) 100%)" }}>
